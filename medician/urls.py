...
urlpatterns = [
   ...
   # url(r'^$', 'profiles.views.registration', name='registration'),
    ...
    url(r'^api/account/user_details/', views.UserQuestionnaireViewSet.as_view({'post': 'create', 'get': 'list'}), name='user_details'),
    url(r'^api/account/add/user_details/(?P<id>[0-9]+)/$', views.UserQuestionnaireViewSet.as_view({'post': 'create', 'get': 'list'}), name='user_details_add'),
    url(r'^api/account/UserAddressSerializer/$', views.UserQuestionnaireViewSet.as_view({'post': 'create', 'get': 'list'}), name='user_details_add'),
