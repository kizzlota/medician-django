    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=255, null=True, unique=True, verbose_name=b'e-mail')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certificates', django.contrib.postgres.fields.jsonb.JSONField()),
                ('experience', models.CharField(blank=True, max_length=200, null=True)),
                ('list_of_diseases', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ('relation_to_doc_categories', models.ManyToManyField(to='profiles.DocCategories')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=100, null=True, verbose_name=b'full user name')),
                ...
                ('rh_factor', models.NullBooleanField()),
                ('blood_transfusion', models.NullBooleanField()),
                ...
                ('relation_to_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name=b'relation field to User model by FK')),
            ],
        ),
        migrations.CreateModel(
            name='UserFiles',
            fields=[
                ...
                ('date_of_add', models.DateField(auto_now_add=True, null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, null=True, to='profiles.UserFiles', verbose_name=b'relation filed to UserFiles by m2m'),
        ),
        migrations.AddField(
            model_name='user',
            name='relation_to_user_analyzes',
            field=models.ManyToManyField(blank=True, null=True, to='profiles.UserAnalyzes'),
        ),
        migrations.AddField(
            model_name='user',
            name='user_details',
